    ...
    <form action="<?php echo URLROOT; ?>/author/addwiki" method="post">
        <div class="mb-4">
            ...
            <input type="text" id="title" name="title"
                class="border rounded w-full py-2 px-3 focus:outline-none focus:ring focus:border-blue-300 <?php echo (!empty($data['title_err'])) ? 'is-invalid' : ''; ?> "
            ...
            <div class="mb-4">
                ...
                <input type="text" id="content" name="content"
                    class="border rounded w-full py-2 px-3 focus:outline-none focus:ring focus:border-blue-300<?php echo (!empty($data['content_err'])) ? 'is-invalid' : ''; ?> "
